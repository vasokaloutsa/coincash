...
import ShopAnywhere from "../assets/images/ShopAnywhere";
...
const Body = () => {
  const iconCardsData = [
    { icon: <AirplaneTickets width="80%"/>, text: ["You can", "book", "tickets"] },
    { icon: <Cart width="80%"/>, text: ["You can", "buy", "groceries"] },
    { icon: <Page width="80%"/>, text: ["You can", "pay", "your bills"] },
  ];
